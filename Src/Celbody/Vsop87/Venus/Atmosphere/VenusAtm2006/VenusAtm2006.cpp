...
{
	static char *name = "SpaceXpanse 2006 Venus atmosphere model";
	return name;
}

DLLCLBK char *ModelDesc ()
{
	static char *desc = "A simple static Venus atmosphere model. This is the model used in SpaceXpanse 2006.";
	return desc;
}