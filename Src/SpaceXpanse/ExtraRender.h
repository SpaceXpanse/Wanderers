...
public:
	Extra_RenderOptions (const spacexpanse::ExtraTab *tab): BuiltinLaunchpadItem (tab) {}
	char *Name ();
	char *Description ();
};
...
public:
	Extra_PlanetRenderOptions (const spacexpanse::ExtraTab *tab): BuiltinLaunchpadItem (tab) {}
	char *Name ();
	char *Description ();
