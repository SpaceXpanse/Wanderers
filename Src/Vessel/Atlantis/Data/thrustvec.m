...
%
% 1. Launch (spacexpanse+ET+SRBs)
% 2. Post SRB-separation (spacexpanse+ET)
%
...
% SSME thrust reference positions in spacexpanse frame
...
ofs_spacexpanse=[0.0, 6.07,-7.895];
ofs_srb_left=[-6.2,-1.91,-5.68];
ofs_srb_right=[6.2,-1.91,-5.68];

% Global thrust positions
p_ssme0 = ofs_spacexpanse+ref_ssme0;
p_ssme1 = ofs_spacexpanse+ref_ssme1;
p_ssme2 = ofs_spacexpanse+ref_ssme2;
...
%% Calculate the thrust moments for spacexpanse+tank configuration

% Component offsets from global CG
ofs_spacexpanse_withtank = [ 0.0, 4.64,-9.285];

% thrust reference positions for spacexpanse+tank configuration
p_ssme0 = ofs_spacexpanse_withtank + ref_ssme0;
p_ssme1 = ofs_spacexpanse_withtank + ref_ssme1;
p_ssme2 = ofs_spacexpanse_withtank + ref_ssme2;

% thrust directions for spacexpanse+tank configuration
...
%% Calculate the thrust moments for spacexpanse OMS
